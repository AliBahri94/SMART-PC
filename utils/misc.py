...
# corruptions = [
#     # 'clean',
#     'distortion_rbf', 'distortion_rbf_inv', 'density', 'density_inc', 'shear',   
# ]

# Part 3
# corruptions = [
#     # 'clean',
#     'rotation', 'cutout', 'distortion', 'occlusion', 'lidar',     
#     # 'mixed_corruptions_2_0', 'mixed_corruptions_2_1', 'mixed_corruptions_2_2'   
# ]
...
# corruptions = [
#     # 'clean',
#     'upsampling', 'distortion_rbf', 'distortion_rbf_inv', 'density' 
# ]  


# corruptions = [
#     # 'clean',
#     'density_inc', 'shear', 'rotation', 'cutout'
# ]  
